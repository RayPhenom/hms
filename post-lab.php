...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_ticket_query = mysqli_query($connection, "UPDATE tbl_ticket SET current_location = 'Clinic-2', updated_at = '$date' WHERE ticket_id = '$ticket_id'");
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="card-title">Clinic Queue</div>
                        <table class="datatable table table-stripped">
                            ...
                            <tbody>
                                ...
                                WHERE tbl_ticket.status = 1 AND tbl_ticket.current_location = 'Labs'
                    ...
                    <div class="table-responsive">
            <div class="card-title">Post-lab Queue</div>
            <table class="datatable table table-stripped">
                <thead>
                    <tr>
                        <th>Ticket Number</th>
                ...
                <tbody>
                    ...
                    WHERE tbl_ticket.status = 1 AND tbl_ticket.current_location = 'Labs' ORDER BY tbl_ticket.updated_at ASC");
